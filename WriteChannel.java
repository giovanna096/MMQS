...
public class WriteChannel<T> extends ReadChannel<T> {
	...
	public Optional<String> peekWriteLabel() {
		synchronized (this) {
	...
	public Optional<T> getWriteValue() {
		synchronized (this) {
			return writeValue;
		} 
	}
	 ...
	 */
	@SuppressWarnings("unchecked")
	public void shadowCopyAndReset() {
		synchronized (this) {
		Optional<T> value = peekWrite();
	 ...
	 * @return
	 */
	public Optional<T> writeShadowCopy() {
		synchronized (this) {
